...
function displayPics(){
  ...
  // Because const is scoped to only displayPics() and the console log is outside of that scope.  Additionally, const only allows you to define that once so you cannot redeclare rando again later.
  console.log(viewed);
